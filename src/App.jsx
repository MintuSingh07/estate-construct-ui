...
import { TbMenu3, TbArrowUpRight } from "react-icons/tb";
...
const App = () => {
  ...
  useGSAP(() => {
    ...
    // Setup quick setters for cursor floating video
    ...
    const handleMouseMove = (e) => {
      // Offset by half the width/height of the floating video to center it perfectly on cursor
      xTo(e.clientX - 200); 
      yTo(e.clientY - 112.5);
    };
          ...
          >
            ...
            {showcaseItems.map((item, idx) => (
              ...
              >
                ...
                {/* Expanding Content (CSS Grid Accordion) */}
